...
INSERT INTO pipeline_stages (id, name, stage_key, stage_type, position, color, is_default, is_won, is_lost, is_system, auto_advance_on) VALUES ('f1978e10-074f-4782-b0ad-942c1fedf63e', 'Prospecto', 'prospect', 'NEW', 1, '#94a3b8', true, false, false, true, '{}');

INSERT INTO pipeline_stages (id, name, stage_key, stage_type, position, color, is_default, is_won, is_lost, is_system, auto_advance_on) VALUES ('b10da4ab-9eb8-4047-b243-7d9784a314b9', 'Calificado', 'qualified', 'QUALIFIED', 2, '#64748b', false, false, false, true, '{}');

INSERT INTO pipeline_stages (id, name, stage_key, stage_type, position, color, is_default, is_won, is_lost, is_system, auto_advance_on) VALUES ('2ece2ffe-10fb-4380-bdd7-789a5f32b20f', 'Contacto encontrado', 'contact_found', 'CONTACT_FOUND', 3, '#0ea5e9', false, false, false, true, '{}');

INSERT INTO pipeline_stages (id, name, stage_key, stage_type, position, color, is_default, is_won, is_lost, is_system, auto_advance_on) VALUES ('40394e68-d64b-40cb-96e0-cc0c1c49aabc', 'Primer contacto', 'first_contact', 'CONTACTED', 4, '#3b82f6', false, false, false, true, ARRAY['EMAIL_SENT']);

INSERT INTO pipeline_stages (id, name, stage_key, stage_type, position, color, is_default, is_won, is_lost, is_system, auto_advance_on) VALUES ('75a64b9e-e80e-4dea-9fe4-0776411a4cf7', 'Email abierto', 'opened', 'OPENED', 5, '#6366f1', false, false, false, true, ARRAY['EMAIL_OPENED']);

INSERT INTO pipeline_stages (id, name, stage_key, stage_type, position, color, is_default, is_won, is_lost, is_system, auto_advance_on) VALUES ('1071a4fd-4e3b-44ed-b044-ca432b190b3b', 'Respondió', 'replied', 'REPLIED', 6, '#8b5cf6', false, false, false, true, ARRAY['EMAIL_REPLIED']);

INSERT INTO pipeline_stages (id, name, stage_key, stage_type, position, color, is_default, is_won, is_lost, is_system, auto_advance_on) VALUES ('a5af7712-f7a7-4613-943d-95d9502c1b87', 'Conversación', 'conversation', 'CONVERSATION', 7, '#a855f7', false, false, false, true, '{}');

INSERT INTO pipeline_stages (id, name, stage_key, stage_type, position, color, is_default, is_won, is_lost, is_system, auto_advance_on) VALUES ('bc26811d-19af-4bf2-a0cc-97f68a61048e', 'Interesado', 'interested', 'INTERESTED', 8, '#d946ef', false, false, false, true, '{}');

INSERT INTO pipeline_stages (id, name, stage_key, stage_type, position, color, is_default, is_won, is_lost, is_system, auto_advance_on) VALUES ('c4d12cae-a128-434f-af92-73ae2958944e', 'Reunión', 'meeting', 'MEETING', 9, '#ec4899', false, false, false, true, '{}');

INSERT INTO pipeline_stages (id, name, stage_key, stage_type, position, color, is_default, is_won, is_lost, is_system, auto_advance_on) VALUES ('79f1430f-f913-4e34-9dd4-440a0a18c2fd', 'Oportunidad', 'opportunity', 'OPPORTUNITY', 10, '#f59e0b', false, false, false, true, '{}');

INSERT INTO pipeline_stages (id, name, stage_key, stage_type, position, color, is_default, is_won, is_lost, is_system, auto_advance_on) VALUES ('5a6d74fa-dcd1-4d61-a262-de720ee85350', 'Propuesta', 'proposal', 'PROPOSAL', 11, '#f97316', false, false, false, true, '{}');

INSERT INTO pipeline_stages (id, name, stage_key, stage_type, position, color, is_default, is_won, is_lost, is_system, auto_advance_on) VALUES ('300b8b05-ea7b-43d5-b35e-b631e4e8558e', 'Negociación', 'negotiation', 'NEGOTIATION', 12, '#ef4444', false, false, false, true, '{}');

INSERT INTO pipeline_stages (id, name, stage_key, stage_type, position, color, is_default, is_won, is_lost, is_system, auto_advance_on) VALUES ('789c3c8c-71b2-4dda-b670-b0844f222fba', 'Ganado', 'won', 'WON', 13, '#22c55e', false, true, false, true, '{}');

INSERT INTO pipeline_stages (id, name, stage_key, stage_type, position, color, is_default, is_won, is_lost, is_system, auto_advance_on) VALUES ('5fb1eb53-bd24-4cb3-a3c5-e7f4fb56dac2', 'Perdido', 'lost', 'LOST', 14, '#71717a', false, false, true, true, '{}');
